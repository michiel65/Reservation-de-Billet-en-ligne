...
import reservationBillet.model.Client;
...
public class ClientGUIReponse extends javax.swing.JFrame {
    ...
    public ClientGUIReponse(AgentClient clientAgent, Reservation reservationPropose) {
        this.clientAgent = clientAgent;
        curentReservation = new Reservation();
        curentReservation.setVol(reservationPropose.getVol());
        curentReservation.setDatreserv(reservationPropose.getDatreserv());
        curentReservation.setDepart(reservationPropose.getDatArrivee());
        curentReservation.setCompagnie(reservationPropose.getCompagnie());
        curentReservation.setCritere(reservationPropose.getCritere());
        curentReservation.setDepart(reservationPropose.getDepart());
        curentReservation.setDatArrivee(reservationPropose.getDatArrivee());
        curentReservation.setDepart(reservationPropose.getDepart());
        curentReservation.setAeroportDepart(reservationPropose.getAeroportDepart());
        curentReservation.setAeroportArrivee(reservationPropose.getAeroportArrivee());
        initComponents();
        
        txtFieldTypVol.setText(reservationPropose.getCritere().getTypevol());
        txtFieldLocalite.setText(reservationPropose.getVol().getAeroportSrc().getNom());
        txtFieldNomCompagnie.setText(reservationPropose.getVol().getCompagnie());
        if(reservationPropose.getCritere().getClassevol().trim()=="Business"){
        txtFieldPrix.setText(Integer.toString((int) reservationPropose.getVol().getPrixBuss()));
        }
        else{
        txtFieldPrix.setText(Integer.toString((int) reservationPropose.getVol().getPrixBuss()));
        }
        ...
        String date1 = simpleDateFormat.format(reservationPropose.getDatArrivee());
        datDebut.setText(date1);
        String date2 = simpleDateFormat.format(reservationPropose.getDepart());
    ...
    private void initComponents() {
        ...
        txtFieldTypVol = new javax.swing.JTextField();
        ...
        txtFieldNomCompagnie = new javax.swing.JTextField();
        ...
        jLabel4.setText("Type Vol");

        jLabel5.setText("Date depart");

        jLabel6.setText("Date Arrivee");

        jLabel7.setText("Prix");

        txtFieldTypVol.setEditable(false);
        ...
        txtFieldNomCompagnie.setEditable(false);
        txtFieldNomCompagnie.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(txtFieldNomCompagnie, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(59, 59, 59))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(txtFieldNomCompagnie, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtFieldTypVol, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JTextField txtFieldNomCompagnie;
    ...
    private javax.swing.JTextField txtFieldTypVol;
